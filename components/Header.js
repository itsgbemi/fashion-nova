...
key={item.name}
href={item.href} 
className={`font-black text-xs uppercase ${getActiveNav() === item.name ? 'border-b-2 border-black' : ''}`}
>
{item.name}
</Link>
))}
...
className="w-full bg-white border border-gray-300 rounded-full px-3 py-3 pl-8 pr-10 text-xs"
/>
...
<i className="fal fa-history text-gray-600 text-base"></i>
<i className="fa-light fa-circle-user text-gray-600 text-base"></i>
<i className="far fa-heart text-gray-600 text-base"></i>
<i className="fa-light fa-bag-shopping text-gray-600 text-base"></i>
</div>
</div>
</div>
</div>
...
key={item.name}
href={item.href} 
className={`whitespace-nowrap px-2 py-1 text-xs font-black uppercase flex-shrink-0 ${getActiveNav() === item.name ? 'border-b-2 border-black' : ''}`}
>
{item.name}
</Link>
))}
