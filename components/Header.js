...
<i className="far fa-history text-gray-600 text-base"></i>
<i className="far fa-user-circle text-gray-600 text-base"></i>
<i className="far fa-heart text-gray-600 text-base"></i>
<i className="far fa-shopping-bag text-gray-600 text-base"></i>
</div>
</div>
</div>
</div>
