...
className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-1 pl-8 pr-10 text-xs"
/>
...
<i className="fas fa-flag hidden lg:block text-gray-600 text-sm"></i>
<i className="fas fa-clock text-gray-600 text-sm"></i>
<i className="far fa-user text-gray-600 text-sm"></i>
<i className="far fa-heart text-gray-600 text-sm"></i>
<i className="fas fa-shopping-bag text-gray-600 text-sm"></i>
</div>
</div>
</div>
</div>
...
<nav className="flex overflow-x-auto scrollbar-hide px-2 pb-1">
{utilityNav.map((item) => (
<Link 
key={item.name}
href={item.href} 
