...
className="w-full bg-white text-black rounded-md px-3 py-2 text-xs"
/>
<button className="absolute right-1 top-1 bg-gray-100 rounded-full w-7 h-7 flex items-center justify-center">
